        ...
        <div className='bg-gray-100 flex rounded-2xl  shadow-2xl max-w-3xl p-5 '>
            ...
            <div className='sm:w-1/2 p-5'>
                ...
                <form action='' className='flex flex-col gap-4'>
                  <input className='py p-2 mt-5 rounded-xl bg-slate-200' type='text'
                    name='username' 
                  ...
                  <p className='text-xs  flex jus'>
                    Already Have An Account?
                     <div className='ml-1 text-blue-600'><Link to='/in'>Login </Link></div>
                  </p>
                </form>
            ...
            <div className='sm:block hidden w-1/2 p-5'>
                <img className="rounded-xl shadow-2xl bg-slate-300 mt-5" src="src/assets/raze.png" alt=''/>
            </div>
        </div>
    </section>
